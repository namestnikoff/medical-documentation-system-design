...
**NFR-016: Соответствие Приказу Минздрава 911н**
- Приказ Минздрава РФ от 24.12.2018 № 911н "Об утверждении требований к государственным информационным системам в сфере здравоохранения субъектов РФ"
- Обязательные функции МИС:
  - Ведение электронных медицинских карт (ЭМК)
  - Протоколирование всех действий с персональными данными и медицинскими документами
  - Резервное копирование с RPO ≤ 5 минут, хранение резервных копий минимум 3 года
  - Контроль целостности данных (контрольные суммы SHA-256, электронная подпись УКЭП)
